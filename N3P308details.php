...
function generate_ratings($rating) {
    $movie_rating = '';
    for ($i = 0; $i < $rating; $i++) {
        $movie_rating .= '<img src="star.png" widht="10" height="10" alt="star"/>';
    }
    return $movie_rating;
}
function generate_avr($movie) {

    global $db;

     $query = 'SELECT 
            TRUNCATE(AVG(review_rating),2) AS avr 
       FROM
           reviews,movie
       WHERE
...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href="N3P308details.php?movie_id=$a $order='review_date'">Date</a></th>
     <th style="width: 10em;"><a href="N3P308details.php?movie_id=$a $order='reviewer_name'">Reviewer</a></th>
     <th><a href="N3P308details.php?movie_id=$a $order='review_comment'">Comments</a></th>
     <th style="width: 5em;"><a href="N3P308details.php?movie_id=$a $order='review_rating'">Rating</a></th>
    </tr>
ENDHTML;
$color="grey";
